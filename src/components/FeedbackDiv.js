...
export default function Feedback(props){
  return(
    <div className="lg:pt-10 overflow-y-hidden h-[300px] min-h-full w-full rounded inline-flex flex-col whitespace-normal lg:w-[42%] xl:w-[35%] lg:min-h-0 lg:shrink-0 lg:pr-4 lg:cursor-pointer select-none">
